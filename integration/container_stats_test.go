...
func testStats(t *testing.T,
	...
	t.Logf("stats: %+v", s)
	t.Logf("1 s.GetAttributes().GetId()")
	require.NotEmpty(t, s.GetAttributes().GetId())
	t.Logf("2 s.GetAttributes().GetMetadata()")
	require.NotEmpty(t, s.GetAttributes().GetMetadata())
	t.Logf("3 s.GetAttributes().GetAnnotations()")
